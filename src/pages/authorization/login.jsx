...
export const Login = () => {
    ...
    return (<div className={[styles.container, 'container'].join(' ')}>
        ...
        <div className={styles.box}>
            <p className={'text text_type_main-default text_color_inactive'}>Вы — новый пользователь? <Link
                to={'/register'}><span className={'linkBlue'}>Зарегистрироваться</span></Link>
            </p>
            <p className={'text text_type_main-default text_color_inactive'}>Забыли пароль? <Link
                to={'/forgot-password'}><span className={'linkBlue'}>Восстановить пароль</span></Link></p>
        </div>
    </div>)
}